...
import { addBrandFilter, addTagFilter, removeBrandFilter, removeTagFilter } from '../../Store/items/actions';
import { getBrandFiltersSelector, getBrandTagsSelector } from '../../Store/items/selectors';
